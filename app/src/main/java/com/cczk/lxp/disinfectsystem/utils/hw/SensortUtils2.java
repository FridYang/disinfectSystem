...
public class SensortUtils2 extends  SerialPortBase{
    private static final String TAG = "SensortUtils2";
    public String temp;
    ...
    //获取单例
    private static SensortUtils2 instance=null;
    public static SensortUtils2 getInstance() {
        if (instance == null) {
            synchronized (SensortUtils2.class) {
                if (instance == null) {
                    instance = new SensortUtils2();
                }
            }
        }
        return instance;
...
//            }
        }if(DataList.size()==5)
        {
            ...
            if(handler!=null) {
                Message msg = handler.obtainMessage();
                msg.what = MainActivity.MsgID_HW_SensortInfo2;
